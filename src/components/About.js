    ...
    <section id="about">
      ...
      <div className="about-container">
        ...
        <div>
          <p>
            ~2020~<br/>
            Having graduated from school into the COVID19 pandemic, I struggled to pursue my dream of becoming a fulltime performing musician. 
            Instead, I chose to pursue a career as a freelance music educator. I have always loved children and working in schools.
            Here, I developed the strong communication skills and personal responsibility skills necessary for success running a self-employed business. 
          ...
          <p>
            ...
            offered by CodeAcademy. I was enjoying honing my skill, but it was difficult to validate a career transition. I had a successful and admittedly overflowing private lesson studio
            of low brass students in the greater Houston area and was expecting the birth of my first child. As 2023 approached, I set a New Year's Resolution to officially begin my career transition.
            I applied for and was accepted to the Flatiron School in NYC for to study software engineering. 
            After completing over 500 hours of coding, undergoing five separate project reviews conducted by experienced instructors, and passing four interview-like coding challenges, I successfully graduated from my program.
          </p>
          <p>
            ~Now~<br/>
            ...
            My wife and I both still teach music lessons and enjoy getting to perform live music when we have time. Overall, we are having a blast being back in NYC!
          </p>
          </div> : null}
